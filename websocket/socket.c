 ...
 */
 ...
 void parsestr(char *request, char *data)
 {
    ...
    strcat(request,"Sec-WebSocket-Accept:bEVeGLZrb9fS3Rj8WzExJdCsedg=\r\n");
//    strcat(request,"Sec-WebSocket-Origin: null\r\n");
  //  strcat(request,"Sec-WebSocket-Location: ws://192.168.124.27:9880\r\n");
 }
